...
ColorCylinderObject::ColorCylinderObject(float size, GraphicResource::Image::Color color, bool isLit) : size(size)
{
	...
	const auto geometryTag = "$ColorCylinder." + std::to_string(size);
