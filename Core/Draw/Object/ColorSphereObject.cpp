...
ColorSphereObject::ColorSphereObject(float size, GraphicResource::Image::Color color, bool isLit) : size(size)
{
	...
	const auto geometryTag = "$ColorSphere." + std::to_string(size);
