...
ColorPlaneObject::ColorPlaneObject(Vector2 scale, GraphicResource::Image::Color color, bool isLit)
{
	...
	{
		Technique tech("Color Plane", RenderingChannel::main);
...
void ColorPlaneObject::SetPosition(Vector3 position) noexcept
{
	this->position = position;
}

void ColorPlaneObject::SetRotation(Rotation rotation) noexcept
{
