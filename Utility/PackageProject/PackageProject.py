...
FILES = [
    'External/physX/physX/libs/release/PhysXNarrowphaseGpu_static_64.lib',
    'External/physX/physX/libs/debug/PhysXNarrowphaseGpu_static_64.lib',
    'External/physX/physX/libs/release/PhysXGpu_64.dll',
]
